...
alter table infectious
    add nation int;
alter table infectious
    add nationElse varchar(20);
alter table infectious
    add education varchar(20);
alter table infectious
    add venerismHis varchar(20);
alter table infectious
    add registerAddr varchar(255);
alter table infectious
    add touchHis int;
--alter table infectious add touchElse varchar(100);
alter table infectious
    add infectRoute varchar(20);
alter table infectious
    add sampleSource varchar(100);
alter table infectious
    add conclusion varchar(100);
alter table infectious
    add checkConfirmDate varchar(10);
alter table infectious
    add hivConfirmDate varchar(10);
alter table infectious
    add checkUnit varchar(100);
alter table infectious
    add updateTime smalldatetime default getdate();