...
<script type="text/javascript">
    jQuery(function ($) {
        ...
        var url = "/doctor/getInfectiousList.jspa?fromDate={0}&toDate={1}&workflowState={2}&queryItem={3}&queryField={4}";
                    ...
                    {"orderable": false, "targets": 10, title: '退回消息', defaultContent: ''},
                    {
                        "orderable": false, "targets": 11, title: '操作',/*className:'center',*/ width: 120, render: function (data, type, row, meta) {
                            return '<div class="hidden-sm hidden-xs action-buttons">' +
                                ...
                                '<a class="hasDetail" href="#" data-Url="/index.jspa?content=/doctor/getInfectious.jspa?infectiousID={0}&menuID=50">'.format(data) +
                                ...
                                (row["workflowChn"] === "接受" ?
                                    '<a class="export" href="#" data-Url="/doctor/getInfectiousPDF.jspa?infectiousID={0}">'.format(data) +
                ...
                buttons: [
                    {
                        ...
                        click: function () {
                            $.ajax({
                                type: "POST",
                                url: "/doctor/deleteInfectious.jspa?infectiousID=" + infectiousID,
        ...
        function submitInfectious(infectiousID, patientName) {
            ...
            var submitUrl = "/doctor/setWorkflow.jspa?objectID={0}&objectType=infectious&workflow=1&flowNote= ".format(infectiousID);
        ...
        function acceptInfectious(infectiousID, patientName) {
            ...
            var submitUrl = "/doctor/setWorkflow.jspa?objectID={0}&objectType=infectious&workflow=3&flowNote= ".format(infectiousID);
            console.log("url:" + submitUrl);
        ...
        function rejectInfectious(infectiousID, patientName) {
            ...
            var submitUrl = "/doctor/setWorkflow.jspa?objectID={0}&objectType=infectious&workflow=2&flowNote={1}";
            //console.log("url:" + submitUrl);
                ...
                buttons: [
                    {
                        ...
                        click: function () {
                            ...
                            var newInfectiousUrl = "index.jspa?content=/doctor/newInfectious.jspa&menuID=50&patientID={0}&hospID={1}&diagnosisDate={2}";
                            if ($('#form-type').val() === '2')
                            ...
                            /*window.open("index.jspa?content=/doctor/newInfectious.jspa&menuID=50&patientID=" + choosePatient["PatID"] +
