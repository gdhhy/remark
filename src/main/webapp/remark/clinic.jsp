    ...
    <script type="text/javascript">
        ...
        jQuery(function ($) {
            ...
            $('.btn-save').click(function () {
                var json = {};
                json.clinicID = $('#clinicID').val();
                json.disItem = $('#disItem').val();
                json.result = $('#result').val();
                json.rational = $('input:radio[name="rational"]:checked').val();
    ...
    <div class="main-content-inner">
        ...
        <div class="page-content">
            <div class="row">
                            ...
                            <table border="1" cellspacing="0" bordercolor="#368E9D" style="border-collapse:collapse">
                                ...
                                <tr>
                                    ...
                                    <td colspan="7" align="center"><input style='border-bottom:0px;border-top:0px;border-left:0px;border-right:0px;'
                                                                          name="disItem" id="disItem" type="text"
                                ...
                                <tr>
                                    ...
                                    <td colspan="5" nowrap="true"><textarea name="result" cols="60" rows="3" id="result">${clinic.result}</textarea></td>
                                    <td align="right" style="font-size: 14px;font-weight:bold;" bgColor="#ffffff">结果</td>
                                    <td>
                                        <input type="radio" value="1"
                                               <c:if test='${clinic.rational==1}'>checked</c:if> name="rational">合理<br/>
                                        <input type="radio" value="0"
                                               <c:if test='${clinic.rational==0}'>checked</c:if> name="rational">不合理
                                    </td>
                                </tr>
                ...
                <input type="hidden" id="clinicID" name="clinicID" value="${clinic.clinicID}"/>
            </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer no-margin-top">
                ...
                <button id="saveQuestionBtn" class="btn btn-sm btn-warning pull-right">
